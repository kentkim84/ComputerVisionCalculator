...
namespace ComputerVision
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private async void ManageImageSource(WriteableBitmap imageSource)
        {
            var buffer = imageSource.PixelBuffer.ToArray();

            await MakeAnalysisRequest(buffer);
        ...
        private static async Task MakeAnalysisRequest(byte[] buffer)
        {
